...
vim.keymap.set('n', '<Leader>aa', ':argadd<CR>', { desc = 'Argumentlist add' })
vim.keymap.set('n', '<Leader>ad', ':argdelete<CR>', { desc = 'Argumentlist delete' })
vim.keymap.set('n', '<Leader>ar', ':argument<CR>', { desc = 'Argumentlist current' })
vim.keymap.set('n', '<Leader>as', ':args<CR>', { desc = 'Argumentlist show' })
...
vim.keymap.set({ 'n', 'v' }, '<C-j>', '10j', { desc = 'Move 10 lines down' })
vim.keymap.set({ 'n', 'v' }, '<C-k>', '10k', { desc = 'Move 10 lines up' })
